...
export default function App() {
  ...
  const [incomingStock, setIncomingStock] = useState(initialIncomingStock);
      ...
      <div style={{ minHeight:"100vh",display:"flex",flexDirection:"column" }}>
        ...
        <div style={{ display:"flex",flex:1 }}>
          ...
          <main style={{ flex:1,padding:32,overflowY:"auto" }}>
            {tab==="Incoming Stock" && <IncomingStockTab data={incomingStock} setData={setIncomingStock} />}
            {tab==="Products" && <ProductsTab data={products} setData={setProducts} orders={orders} />}
            {tab==="Production" && <ProductionTab data={production} setData={setProduction} incomingStock={incomingStock} setIncomingStock={setIncomingStock} products={products} setProducts={setProducts} recipes={recipes} />}
            {tab==="Orders" && <OrdersTab data={orders} setData={setOrders} products={products} />}
            {tab==="Settings" && <SettingsTab products={products} incomingStock={incomingStock} recipes={recipes} setRecipes={setRecipes} />}
          </main>
        </div>
